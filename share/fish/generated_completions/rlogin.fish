...
complete -c rlogin -s 4 -d 'Forces rlogin to use IPv4 addresses only'
complete -c rlogin -s 6 -d 'Forces rlogin to use IPv6 addresses only'
complete -c rlogin -s A -d 'Enables forwarding of connections from an authentication agent such as ssh-ag…'
complete -c rlogin -s a -d 'Disables forwarding of the authentication agent connection'
...
complete -c rlogin -s E -d 'Append debug logs to log_file instead of standard error'
...
complete -c rlogin -s k -d 'Disables forwarding (delegation) of GSSAPI credentials to the server'
...
complete -c rlogin -s T -d 'Disable pseudo-terminal allocation'
complete -c rlogin -s t -d 'Force pseudo-terminal allocation'
complete -c rlogin -s V -d 'Display the version number and exit'
...
complete -c rlogin -s x -d 'Disables X11 forwarding'
