...
complete -c rsh -s 4 -d 'Forces rsh to use IPv4 addresses only'
complete -c rsh -s 6 -d 'Forces rsh to use IPv6 addresses only'
complete -c rsh -s A -d 'Enables forwarding of connections from an authentication agent such as ssh-ag…'
complete -c rsh -s a -d 'Disables forwarding of the authentication agent connection'
...
complete -c rsh -s E -d 'Append debug logs to log_file instead of standard error'
...
complete -c rsh -s k -d 'Disables forwarding (delegation) of GSSAPI credentials to the server'
...
complete -c rsh -s T -d 'Disable pseudo-terminal allocation'
complete -c rsh -s t -d 'Force pseudo-terminal allocation'
complete -c rsh -s V -d 'Display the version number and exit'
...
complete -c rsh -s x -d 'Disables X11 forwarding'
